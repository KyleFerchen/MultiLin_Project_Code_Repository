...
JOB_NAME="cbnet_fold_0_Ebf1_proB_Hmga2"
DIR=$(pwd)
...
chrombpnet pipeline \
-ibam "/data/salomonis2/LabFiles/Kyle/Analysis/2023_06_12_tea_seq_atac_processing/output/tea_r7_merged_bams/merged_sorted_cluster_Ebf1+ proB_Hmga2_bam_split.bam" \
-d "ATAC" \
...
-o cluster_specific_models/fold_0/chrombpnet_model_fold_0_Ebf1_proB_Hmga2/
