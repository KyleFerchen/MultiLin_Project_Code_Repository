...
chrombpnet pipeline \
-ibam /data/salomonis2/LabFiles/Kyle/Analysis/2023_06_12_tea_seq_atac_processing/output/tea_r7_merged_bams/merged_sorted_cluster_ERP1_bam_split.bam \
-d "ATAC" \
...
-o /users/fero3l/chrombpnet_model_fold_0_ERP1/


echo "Moving folder back to salomonis2"
mv /users/fero3l/chrombpnet_model_fold_0_ERP1/ \
