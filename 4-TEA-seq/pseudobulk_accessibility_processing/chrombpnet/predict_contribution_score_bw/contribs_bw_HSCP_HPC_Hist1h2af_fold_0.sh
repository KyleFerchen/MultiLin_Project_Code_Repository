...
JOB_NAME="contribs_bw_fold_0_HSCP_HPC_Hist1h2af"
DIR=$(pwd)
...
mkdir /users/fero3l/contribs_bw_fold_0_HSCP_HPC_Hist1h2af/
...
--model-h5 cluster_specific_models/fold_0/chrombpnet_model_fold_0_HSCP_HPC_Hist1h2af/models/chrombpnet_nobias.h5 \
...
--output-prefix /users/fero3l/contribs_bw_fold_0_HSCP_HPC_Hist1h2af/contribs_bw_fold_0_HSCP_HPC_Hist1h2af


echo "moving results to salomonis2"

mv /users/fero3l/contribs_bw_fold_0_HSCP_HPC_Hist1h2af/ \
