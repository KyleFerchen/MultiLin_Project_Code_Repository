...
JOB_NAME="contribs_bw_fold_0_CD127_MP"
DIR=$(pwd)
...
mkdir /users/fero3l/contribs_bw_fold_0_CD127_MP/
...
--model-h5 cluster_specific_models/fold_0/chrombpnet_model_fold_0_CD127_MP/models/chrombpnet_nobias.h5 \
...
--output-prefix /users/fero3l/contribs_bw_fold_0_CD127_MP/contribs_bw_fold_0_CD127_MP


echo "moving results to salomonis2"

mv /users/fero3l/contribs_bw_fold_0_CD127_MP/ \
