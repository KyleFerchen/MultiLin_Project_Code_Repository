...
JOB_NAME="contribs_bw_fold_0_MPP4_Hlf"
DIR=$(pwd)
...
mkdir /users/fero3l/contribs_bw_fold_0_MPP4_Hlf/
...
--model-h5 cluster_specific_models/fold_0/chrombpnet_model_fold_0_MPP4_Hlf/models/chrombpnet_nobias.h5 \
...
--output-prefix /users/fero3l/contribs_bw_fold_0_MPP4_Hlf/contribs_bw_fold_0_MPP4_Hlf


echo "moving results to salomonis2"

mv /users/fero3l/contribs_bw_fold_0_MPP4_Hlf/ \
