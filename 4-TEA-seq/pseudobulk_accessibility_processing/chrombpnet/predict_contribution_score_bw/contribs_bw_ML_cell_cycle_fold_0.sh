...
JOB_NAME="contribs_bw_fold_0_ML_cell_cycle"
DIR=$(pwd)
...
mkdir /users/fero3l/contribs_bw_fold_0_ML_cell_cycle/
...
--model-h5 cluster_specific_models/fold_0/chrombpnet_model_fold_0_ML_cell_cycle/models/chrombpnet_nobias.h5 \
...
--output-prefix /users/fero3l/contribs_bw_fold_0_ML_cell_cycle/contribs_bw_fold_0_ML_cell_cycle


echo "moving results to salomonis2"

mv /users/fero3l/contribs_bw_fold_0_ML_cell_cycle/ \
