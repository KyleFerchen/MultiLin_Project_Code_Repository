...
JOB_NAME="contribs_bw_fold_0_HSCP_HPC_Cenpf"
DIR=$(pwd)
...
mkdir /users/fero3l/contribs_bw_fold_0_HSCP_HPC_Cenpf/
...
--model-h5 cluster_specific_models/fold_0/chrombpnet_model_fold_0_HSCP_HPC_Cenpf/models/chrombpnet_nobias.h5 \
...
--output-prefix /users/fero3l/contribs_bw_fold_0_HSCP_HPC_Cenpf/contribs_bw_fold_0_HSCP_HPC_Cenpf


echo "moving results to salomonis2"

mv /users/fero3l/contribs_bw_fold_0_HSCP_HPC_Cenpf/ \
