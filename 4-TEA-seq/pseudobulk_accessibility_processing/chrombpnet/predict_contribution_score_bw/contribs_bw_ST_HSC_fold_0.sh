...
JOB_NAME="contribs_bw_fold_0_ST_HSC"
DIR=$(pwd)
...
mkdir /users/fero3l/contribs_bw_fold_0_ST_HSC/
...
--model-h5 cluster_specific_models/fold_0/chrombpnet_model_fold_0_ST_HSC/models/chrombpnet_nobias.h5 \
...
--output-prefix /users/fero3l/contribs_bw_fold_0_ST_HSC/contribs_bw_fold_0_ST_HSC


echo "moving results to salomonis2"

mv /users/fero3l/contribs_bw_fold_0_ST_HSC/ \
