...
JOB_NAME="contribs_bw_fold_0_MPP5_Egr1"
DIR=$(pwd)
...
mkdir /users/fero3l/contribs_bw_fold_0_MPP5_Egr1/
...
--model-h5 cluster_specific_models/fold_0/chrombpnet_model_fold_0_MPP5_Egr1/models/chrombpnet_nobias.h5 \
...
--output-prefix /users/fero3l/contribs_bw_fold_0_MPP5_Egr1/contribs_bw_fold_0_MPP5_Egr1


echo "moving results to salomonis2"

mv /users/fero3l/contribs_bw_fold_0_MPP5_Egr1/ \
